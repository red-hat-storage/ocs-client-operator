...
func (r *storageClientReconcile) reconcileVolumeGroupSnapshot() error {
	...
	if crd.UID == "" {
		r.log.Info("VolumeGroupSnapshotClass CRD is not available", "crdName", VolumeGroupSnapshotClassCrdName)
		return nil
	}
...
func (r *storageClientReconcile) reconcileOdfVolumeGroupSnapshot() error {
	...
	// CRD doesn't exist in the cluster
	if crd.UID == "" {
		r.log.Info("ODF-VolumeGroupSnapshotClass CRD is not available", "crdName", OdfVolumeGroupSnapshotClassCrdName)
		return nil
	}
