...
func (r *storageClientReconcile) reconcilePhases() (ctrl.Result, error) {
	...
	if storageClientResponse.RbdDriverRequirements != nil {
		...
		if len(storageClientResponse.RbdDriverRequirements.TopologyDomainLables) > 0 {
			r.storageClient.Status.RbdDriverRequirements.TopologyDomainLabels = append(
				r.storageClient.Status.RbdDriverRequirements.TopologyDomainLabels,
				storageClientResponse.RbdDriverRequirements.TopologyDomainLables...)
		}
	}
