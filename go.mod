...
replace (
	github.com/ceph/ceph-csi-operator/api => github.com/Madhu-1/ceph-csi-operator/api v0.0.0-20240807110810-f92ddf7cc527
	github.com/portworx/sched-ops => github.com/portworx/sched-ops v0.20.4-openstorage-rc3 // required by Rook v1.12
	github.com/red-hat-storage/ocs-operator/v4 => github.com/leelavg/ocs-operator/v4 v4.0.0-20240807042613-a481ae6911fb
