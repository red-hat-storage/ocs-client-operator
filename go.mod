...
replace (
	github.com/ceph/ceph-csi-operator => github.com/nb-ohad/ceph-csi-operator v0.0.0-20240628101342-f51faded2542
...
require (
	github.com/ceph/ceph-csi-operator v0.0.0-20240626184829-dd411d561420
