...
replace (
	...
	github.com/red-hat-storage/ocs-operator/services/provider/api/v4 => github.com/parth-gr/ocs-operator/services/provider/api/v4 v4.0.0-20250613071846-300bd6edfa16
...
require (
	github.com/ceph/ceph-csi-operator/api v0.0.0-20250327115748-ae5677274f13
	...
	github.com/red-hat-storage/ocs-operator/services/provider/api/v4 v4.0.0-20250407140600-29da539df4d8
