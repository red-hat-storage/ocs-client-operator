...
replace github.com/red-hat-storage/ocs-operator/v4 => github.com/leelavg/ocs-operator/v4 v4.0.0-20240405120730-df12158a7b32
...
require (
	...
	github.com/red-hat-storage/ocs-operator/v4 v4.0.0-20240401090154-4689ec087b5b
