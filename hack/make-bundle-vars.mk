...
OCS_TLS_BUNDLE_NAME ?= ocs-tls-profiles
OCS_TLS_REGISTRY_NAMESPACE ?= ocs-dev
OCS_TLS_BUNDLE_IMG_NAME ?= $(OCS_TLS_BUNDLE_NAME)-bundle
OCS_TLS_BUNDLE_VERSION ?= v4.22.0
OCS_TLS_BUNDLE_IMG_TAG ?= main-9fd1952
...
OCS_TLS_BUNDLE_IMG ?= $(IMAGE_REGISTRY)/$(OCS_TLS_REGISTRY_NAMESPACE)/$(OCS_TLS_BUNDLE_IMG_NAME):$(OCS_TLS_BUNDLE_IMG_TAG)
...
DEFAULT_CSI_IMG_PROVISIONER_VERSION ?= v6.2.0
DEFAULT_CSI_IMG_ATTACHER_NAME ?= csi-attacher
DEFAULT_CSI_IMG_ATTACHER_VERSION ?= v4.12.0
DEFAULT_CSI_IMG_RESIZER_NAME ?= csi-resizer
DEFAULT_CSI_IMG_RESIZER_VERSION ?= v2.1.0
DEFAULT_CSI_IMG_SNAPSHOTTER_NAME ?= csi-snapshotter
DEFAULT_CSI_IMG_SNAPSHOTTER_VERSION ?= v8.5.0
DEFAULT_CSI_IMG_SNAPSHOT_METADATA_NAME ?= csi-snapshot-metadata
DEFAULT_CSI_IMG_SNAPSHOT_METADATA_VERSION ?= v1.0.0
DEFAULT_CSI_IMG_REGISTRAR_NAME ?= csi-node-driver-registrar
DEFAULT_CSI_IMG_REGISTRAR_VERSION ?= v2.17.0
DEFAULT_CSI_IMG_ADDONS_NAME ?= k8s-sidecar
DEFAULT_CSI_IMG_ADDONS_VERSION ?= v0.14.0
DEFAULT_CSI_IMG_CEPH_CSI_NAME ?= cephcsi
DEFAULT_CSI_IMG_CEPH_CSI_VERSION ?= v3.17.0
...
# for u/s we use same images for all the versions mentioned below
CSI_OCP_VERSIONS ?= v4.23 v4.22
